...
import "./App.css"
import { num, alpha, upAlpha, spChar } from './Characters'
...
const App = () => {
  ...
  const handleGeneratePassword = () => {
    if (!includeUpperCase && !includeLowerCase && !includeNumbers && !includeSymbols) {
      ...
      let characterList = ""
      if (includeNumbers) {
        characterList = characterList + num
      }
      if (includeUpperCase) {
        characterList = characterList + upAlpha
      }
      if (includeLowerCase) {
        characterList = characterList + alpha
      }
      if (includeSymbols) {
        characterList = characterList + spChar
      }
